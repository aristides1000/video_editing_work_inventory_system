...
(2, 2, 2, "./equipment_image/default_image.png", "./qr_equipment_image/default_qr.png"),
...
CREATE TABLE IF NOT EXISTS warehouses (
  ...
  date TIMESTAMP TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP NOT NULL,
