<?php
  ...
  if(isset($_POST['id_equipment']) && $_POST['id_equipment']!='' && isset($_POST['equipment_category_id']) && $_POST['equipment_category_id']!='' && isset($_POST['type_of_equipment_id']) && $_POST['type_of_equipment_id']!='' && isset($_POST['equipment_status_id']) && $_POST['equipment_status_id']!='' && isset($_POST['in_the_warehouse']) && $_POST['in_the_warehouse']!='' && isset($_POST['type_of_activity_id']) && $_POST['type_of_activity_id']!='' && isset($_POST['activity']) && $_POST['activity']!='' && isset($_POST['responsible_id']) && $_POST['responsible_id']!='' && isset($_POST['verified_by_id']) && $_POST['verified_by_id']!='' && isset($_POST['is_deleted']) && $_POST['is_deleted']!='') {
    /* para verificar si llegan o no datos de imagenes
    isset($_FILES['image_path']['name']) && $_FILES['image_path']['name']!='' */
    #llegaron los datos
